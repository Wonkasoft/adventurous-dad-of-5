 ...
 */
function adventurous_dad_of_5_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'adventurous_dad_of_5_content_width', 640 );
}
add_action( 'after_setup_theme', 'adventurous_dad_of_5_content_width', 0 );
